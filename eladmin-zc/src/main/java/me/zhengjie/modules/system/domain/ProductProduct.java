...
public class ProductProduct implements Serializable {
    ...
    @Column(name = "check_card_id2")
    @ApiModelProperty(value = "检验卡片id2")
    private Long checkCardId2;

    @Column(name = "product2")
    @ApiModelProperty(value = "产品名称2")
    private String product2;

    public void copy(ProductProduct source){
